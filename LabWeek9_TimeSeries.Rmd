...
- Is there an overall trend? --> yes there seems to be an increase in the overall level
- Is there seasonality? --> looks like it 
- Any cyclicality evident? --> giant spike and then little spike, but magnitude of one of these seems to be decreasing as we move through time
