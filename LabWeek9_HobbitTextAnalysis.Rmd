---
title: "Lab Week 9 - Hobbit Text Analysis"
...
Breaking it down into pages and lines

```{r}
hobbit_lines <- data.frame(hobbit_text) %>%  #this is breaking it down into each of the pages
...
hobbit_chapts <- hobbit_lines %>% 
  slice(-(1:137)) %>% #dropping the first lines 
  ...
  # if you see an NA in the chapter column, take chapter 1 and fill it in for all the NAs until you get to chapter 2, and then it will fill NAs until you hit the next chapter 
...
#this takes the roman numerals and then converts them into a factor
```
